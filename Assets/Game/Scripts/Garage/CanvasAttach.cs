...
public class CanvasAttach : MonoBehaviour {
	...
	public static CanvasAttach Instance{	get{if(instance == null) instance = GameObject.FindObjectOfType<CanvasAttach>() as CanvasAttach; return instance;}}
	#endregion
	...
	public void CheckUIs (){
		...
		frontSuspensionDistances.value = Instance.activePlayerVehicle.FrontLeftWheelCollider.wheelCollider.suspensionDistance;
		rearSuspensionDistances.value = Instance.activePlayerVehicle.RearLeftWheelCollider.wheelCollider.suspensionDistance;
		frontSuspensionDampers.value = Instance.activePlayerVehicle.FrontLeftWheelCollider.wheelCollider.suspensionSpring.damper;
		rearSuspensionDampers.value = Instance.activePlayerVehicle.RearLeftWheelCollider.wheelCollider.suspensionSpring.damper;
		frontSuspensionSprings.value = Instance.activePlayerVehicle.FrontLeftWheelCollider.wheelCollider.suspensionSpring.spring;
		rearSuspensionSprings.value = Instance.activePlayerVehicle.RearLeftWheelCollider.wheelCollider.suspensionSpring.spring;
	...
	public void SetFrontSuspensionsSpringForceBySlider (Slider slider){
		...
		Custamization.SetFrontSuspensionsSpringForce (Instance.activePlayerVehicle, Mathf.Clamp(slider.value, 10000f, 100000f));

	}

	public void SetRearSuspensionsSpringForceBySlider (Slider slider){

		Custamization.SetRearSuspensionsSpringForce (Instance.activePlayerVehicle, Mathf.Clamp(slider.value, 10000f, 100000f));

	}

	public void SetFrontSuspensionsSpringDamperBySlider (Slider slider){

		Custamization.SetFrontSuspensionsSpringDamper (Instance.activePlayerVehicle, Mathf.Clamp(slider.value, 1000f, 10000f));

	}

	public void SetRearSuspensionsSpringDamperBySlider (Slider slider){

		Custamization.SetRearSuspensionsSpringDamper (Instance.activePlayerVehicle, Mathf.Clamp(slider.value, 1000f, 10000f));
