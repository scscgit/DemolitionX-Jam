...
public class Custamization : MonoBehaviour
{
    ...
    public static void LoadStats(VehiclePhysics vehicle)
    {
        ...
        SetMaximumTorque(vehicle,
            PlayerPrefs.GetFloat(vehicle.transform.name + "_MaximumTorque", vehicle.engineTorque));

        string drvtrn = PlayerPrefs.GetString(vehicle.transform.name + "_DrivetrainMode",
            vehicle._wheelTypeChoise.ToString());
        ...
        SetCounterSteering(vehicle,
            SaveData.GetBool(vehicle.transform.name + "_CounterSteering", vehicle.applyCounterSteering));
        ...
        SetClutchMargin(vehicle,
            SaveData.GetBool(vehicle.transform.name + "ClutchMargin", vehicle.useClutchMarginAtFirstGear));
    ...
    public static void ResetStats(VehiclePhysics vehicle, VehiclePhysics defaultCar)
    {
        ...
        SetFrontSuspensionsSpringForce(vehicle,
            defaultCar.FrontLeftWheelCollider.wheelCollider.suspensionSpring.spring);
        SetRearSuspensionsSpringForce(vehicle, defaultCar.RearLeftWheelCollider.wheelCollider.suspensionSpring.spring);

        SetFrontSuspensionsSpringDamper(vehicle,
            defaultCar.FrontLeftWheelCollider.wheelCollider.suspensionSpring.damper);
