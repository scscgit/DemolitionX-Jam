...
public class CommonSettings : ScriptableObject
{
    ...
    public static CommonSettings Instance
    {
        get
        {
            if (instance == null) instance = Resources.Load("ScriptableObjects/CommonSettings") as CommonSettings;
            return instance;
        }
    }
    ...
    [Header("Particles")] public GameObject engineSmoke;
    ...
    [Header("Optimization")] public bool dontUseAnyParticleEffects = false;
