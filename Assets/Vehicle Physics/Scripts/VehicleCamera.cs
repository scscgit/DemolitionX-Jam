...
public class VehicleCamera : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        tiltAngle = Mathf.Lerp(tiltAngle,
            (Mathf.Clamp(-playerCar.InverseTransformDirection(playerRigid.velocity).x, -35, 35)), Time.deltaTime * 2f);
    ...
    void FirstUpdate()
    {
        ...
        transform.position = hoodCameraObj.transform.position;
        transform.rotation =
            Quaternion.Lerp(transform.rotation, hoodCameraObj.transform.rotation, Time.deltaTime * 10f);
    }
    ...
    void TPSUpdate()
    {
        ...
        currentHeight = Mathf.Lerp(currentHeight,
            wantedHeight + Mathf.Lerp(-1f, 0f, (playerRigid.velocity.magnitude * 3f) / 20f),
