...
public class GroundMaterials : ScriptableObject {
	...
	public static GroundMaterials Instance{	get{if(instance == null) instance = Resources.Load("ScriptableObjects/GroundMaterials") as GroundMaterials; return instance;}}
